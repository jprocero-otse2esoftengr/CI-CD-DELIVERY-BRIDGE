            ...
            steps {
                dir('.') {
                    bat """
                        ...
                        npx e2e-bridge-cli deploy repository/BuilderUML/regtestlatest.rep -h ${params.BRIDGE_HOST} -u ${params.BRIDGE_USER} -P ${params.BRIDGE_PASSWORD} -p ${params.BRIDGE_PORT} -c ${params.CONTROL_PORT} -o overwrite
                    """
                }
            }
        }
