...
set INSTANCES_HOME=C:\Users\jproc\Desktop\CI-CD-DELIVERY-master\CI-CD-DELIVERY-master\.$bin
set INSTANCE_HOME=C:\Users\jproc\Desktop\CI-CD-DELIVERY-master\CI-CD-DELIVERY-master\.$bin\BuilderUML.regtestlatest.regtestlatest
